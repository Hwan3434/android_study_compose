...
class ContentUseCaseImpl(
    ...
    override suspend fun getContent(query: ContentQueryEntity): Result<ContentPagingResult> = coroutineScope {
        Log.e("ContentUseCaseImpl", "getContent: ${query.query}")
        ...
        Log.e("ContentUseCaseImpl", "state 3")
        ...
        Log.e("ContentUseCaseImpl", "state 4")
        // 결과 데이터를 결합하여 dateTime 기준 내림차순 정렬
        val sortedList = (imageData + movieData)

        Log.e("ContentUseCaseImpl", "state 5")
        ...
        Log.e("ContentUseCaseImpl", "state 6")
